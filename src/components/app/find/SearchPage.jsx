  ...
  return (
    <>
      <div className="flex flex-row">
        <div
          className={`${
            filterShow ? `basis-0 hidden` : `basis-3/12 block`
          } flex flex-col border-r-2 p-4`}
        >
          <div className="flex gap-64 pb-4">
            <button className="underline">Réintialiser</button>
            <button className="underline" onClick={handleShowFilter}>
              Fermer
            </button>
          </div>
        ...
        <div
          className={`${
            filterShow ? `basis-full` : `basis-9/12`
          } gap-4 flex flex-col justify-center mx-6 mt-20 py-10 px-10 lg:py-16 lg:mx-auto lg:mt-8`}
        >
          ...
          <div className="text-center text-xl text-black">Résultat</div>
          <div className="text-center">Trier par : (asc)</div>
          <div className="flex flex-col items-center">
            <div
              className={`${
                filterShow ? `lg:grid-cols-3` : `lg:grid-cols-2`
...
export const stock = ["disponible"]
export const product = ["table", "canape", "lit", "chaise"]
