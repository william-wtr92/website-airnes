  ...
  return (
    <div className="flex bg-[#709861] h-10 justify-start">
      ...
      <div className="flex mt-2 gap-6">
        <NavLink href="/"><UserIcon className="h-6" color={"#fff"} /></NavLink>
        <NavLink href="/"><MagnifyingGlassIcon className="h-6" color={"#fff"}/></NavLink>
        <NavLink href="/"><ShoppingCartIcon className="h-6" color={"#fff"} /></NavLink>
      </div>
      <div className="mt-2 ml-10 mr-4">
        <NavLink href="/"><Bars3Icon className="h-6" color={"#fff"}/></NavLink>
      </div>
    </div>
  )
}
