...
import ProductOrder from "@/components/category/ProductOrder"
                ...
                <div>
                    ...
                    <div className="grid lg:grid-cols-2 mb-10 ">
                        ...
                        <div className="px-[20%] flex flex-col w-full ">
                            ...
                            <div id={"divider"} className="border-b-black border-b my-10"></div>
                            <div id={"Adresse Livraison"}>
                                <div className="flex flex-col">
                                    <p className="font-bold text-md lg:text-2xl mb-3">Adresse de livraison</p>
                            ...
                            <div id={"Adresse facturation"}>
                                <div className="flex flex-col">
                                    <p className="font-bold text-md lg:text-2xl mb-3">Adresse de Facturation</p>
                                    <p className="lg:text-xl text-gray-500">John Smith</p>
                                    <p className="lg:text-xl text-gray-500">13 rue de la Lune</p>
                                    <p className="lg:text-xl text-gray-500">75004 Paris</p>
                                    <p className="lg:text-xl text-gray-500">FRANCE</p>
                            ...
                            <div id={"divider"} className="border-b-black border-b my-5"></div>
                            <div id={"Méthode de payments"}>
                                <p className="font-bold text-md lg:text-2xl mb-3">Méthode de paiement</p>
