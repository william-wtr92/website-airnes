  ...
  return (
    <>
      <div className="overflow-y-auto">
        <div
          className="text-gray-600 flex justify-center mt-10 gap-2 lg:gap-4 lg:absolute lg:top-0 lg:left-[15%] lg:w-5/6">
        ...
        <div className="flex flex-col gap-4 w-screen lg:w-[60%] lg:relative lg:pb-10 lg:left-[27%]">
          <div>
            <h3
              className="flex justify-center text-md font-black text-gray-600 pb-6 lg:text-2xl lg:relative lg:right-[35%]">
              Meilleurs Ventes
            </h3>
          </div>
