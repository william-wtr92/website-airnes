const routes = {
  ...
  api: {
    ...
    admin: {
      ...
      materials: {
        getMaterialsAndCategory: () =>
          "/admin/materials/materialsAndCategories",
    ...
    user: {
      ...
      changePasswordUser: (userId) => `/user/${userId}/changePassword`,
      order: {
        ...
        returnProduct: (userId, orderId) =>
          `/user/${userId}/order/${orderId}/return`,
      },
      address: {
